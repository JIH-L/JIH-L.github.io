  ...
  return (
    <nav className="sticky top-0 z-40 flex items-center bg-white p-6 shadow-md dark:bg-neutral-800 dark:text-white">
      ...
      <span
        className={`${
          toggle
            ? 'border-opacity-0 before:rotate-45 after:bottom-1/2 after:rotate-[135deg]'
      ...
      ></span>
      <ul
        className={`absolute left-0 top-[76px] mr-2 grid min-h-full w-full bg-white transition-opacity dark:bg-neutral-800 md:relative md:top-0 md:flex md:justify-end md:opacity-100 ${
