...
import apro from '../../assets/images/apro.webp'
  ...
  return (
    <ProjectLayout>
      <div className="flex flex-col items-center justify-center">
        ...
        <a
          target="_blank"
          href="https://www.nestlebaby.com.tw/apro3"
      ...
      <div className="px-16 text-sm">
        ...
        <ul className="ml-4 list-disc leading-loose dark:text-gray-300 ">
          ...
          <li>Integrated Google Map API.</li>
        </ul>
        <h2 className="mb-6 mt-8 text-xl font-semibold leading-normal dark:text-white md:text-lg xl:text-xl">
          Skills
        </h2>
        <p>Twig, SCSS, jQuery, GSAP, RWD, Google Map API </p>
      </div>
    </ProjectLayout>
  )
}
